...
class Restaurant(db.Model, SerializerMixin):
    ...
    # Association Proxy: A Restaurant has many Pizzas through RestaurantPizza
    pizzas = association_proxy("restaurant_pizzas", "pizza")

    serialize_rules = ("-restaurant_pizzas.restaurant",)  # Avoid infinite recursion
...
class Pizza(db.Model, SerializerMixin):
    ...
    # Association Proxy: A Pizza has many Restaurants through RestaurantPizza
    restaurants = association_proxy("restaurant_pizzas", "restaurant")

    serialize_rules = ("-restaurant_pizzas.pizza",)  # Avoid infinite recursion
